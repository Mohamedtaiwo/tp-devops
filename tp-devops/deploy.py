...
with open("deploy.log", "a") as log_file:
    log_file.write("Debut du deploiement...\n")
...
with open("deploy.log", "a") as log_file:
    log_file.write(f"App deployee sur localhost:{port}\n")
